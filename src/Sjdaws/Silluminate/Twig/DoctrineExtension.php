...
/*
 * This file has been taken directly from Doctrine with just
 * a change in namespace.
 *
 * You should be able to upgrade to the latest version whenever
 * a new one becomes available.
 *
 * Original URL: https://github.com/doctrine/DoctrineBundle/blob/master/Twig/DoctrineExtension.php
 */
